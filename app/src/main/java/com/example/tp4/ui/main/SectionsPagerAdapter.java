    ...
    public CharSequence getPageTitle(int position) {
        ...
        switch (position) {
            case 0:
                ...
                icone = mContext.getResources().getDrawable(R.drawable.icon_mineral);
                break;
            case 1:
                titre = mContext.getString(R.string.titre_section1).toUpperCase(l);
                icone = mContext.getResources().getDrawable(R.drawable.icon_vegetal);
                break;
            case 2:
                titre = mContext.getString(R.string.titre_section2).toUpperCase(l);
                icone = mContext.getResources().getDrawable(R.drawable.icon_animal);
                break;
        }
